...
namespace CTRPluginFramework {
    ...
    namespace PKHeX {
        ...
        bool ConfigureBoxAndPosition() {
            ...
            if (!KeyboardHandler<u8>::Set(getLanguage->Get("EDITOR_BOX"), true, false, 2, gBoxNumber, 0, 1, 32))
    ...
    bool SetBoxPosition(u8 &srcBox, u8 &srcPosition, u8 &destBox, u8 &destPosition) {
        ...
        if (!KeyboardHandler<u8>::Set(getLanguage->Get("EDITOR_CLONE_START_BOX"), true, false, 2, srcBox, 1, 1, 32) ||
        ...
        if (!KeyboardHandler<u8>::Set(getLanguage->Get("EDITOR_CLONE_PASTE_BOX"), true, false, 2, destBox, 1, 1, 32) ||
